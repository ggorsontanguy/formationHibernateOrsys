...
create table t_media (discriminant varchar(31) not null, identifiant bigint not null auto_increment, auteur varchar(100), titre varchar(100), version bigint not null, isbn varchar(12) not null, pages integer, primary key (identifiant))
